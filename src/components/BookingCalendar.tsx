        ...
        {currentStep === 'services' && (
          <div className="space-y-6">
            <div className="text-center mb-6">
              ...
              <p className="text-xl text-foreground font-medium bg-primary/10 rounded-lg py-3 px-4 inline-block mb-4">
                Select services below, or describe what you need
              </p>
              <div>
                <a
                  href="#contact"
                  className="inline-flex items-center gap-2 text-primary hover:text-primary/80 font-medium text-base"
                >
