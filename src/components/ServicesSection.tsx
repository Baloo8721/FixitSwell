...
const serviceCategories = [
  {
    icon: Wrench,
    title: "Repairs, Maintenance & Installations",
    services: [
      "To-do lists & touch-ups",
      "Furniture & shelf assembly",
      "TV mount & soundbar setup",
      "Ceiling fan install & swap",
      ...
      "Door & cabinet repairs",
      "Blind & curtain rod install",
      "Bed frame assembly",
      "Appliance install & hookup",
      "Dryer vent cleaning",
    ],
  },
  {
    icon: Leaf,
    title: "Outdoor, Cleaning & Seasonal",
    services: [
      "Pressure wash driveway & walkways",
      "Pressure wash exterior & windows",
      "Mobile home roof cleaning",
      "Gutter cleaning & minor repair",
      "Mobile home roof coating",
      "Light yard cleanup & gardening",
      "Monthly yard & litter clean",
      "Storm prep & takedown",
      "Holiday light setup & removal",
      "HVAC filter & drip line service",
    ],
  },
  {
    icon: ShieldCheck,
    title: "Senior Support, Safety & Organizing",
    services: [
      "Grab bar & handrail install",
      "Home hazard audit",
      "Non-slip mats & night lights",
      "Smoke detector battery & swap",
      "Smart tech setup (locks, cameras, thermostat)",
      "TV, streaming & device help",
      "Wellness check-ins & snowbird monitoring",
      "Delivery & contractor wait time",
      "Kitchen, closet & room organizing",
      "Garage & shed sort",
